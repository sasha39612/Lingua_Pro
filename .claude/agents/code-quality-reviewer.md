...
description: "Code quality reviewer. Invoked via the /code-review command — do not launch automatically."
tools: Bash
model: sonnet
color: blue
---
...
This is a Next.js 15 + React 19 application using:
- TypeScript 5 in strict mode
- Tailwind CSS with CSS Modules for component styling
- Vitest + React Testing Library for testing
- Path alias `@/*` for imports from `src/`
- next-intl for i18n (cookie-based locale, no URL prefix; translation strings via `useTranslations()`)
